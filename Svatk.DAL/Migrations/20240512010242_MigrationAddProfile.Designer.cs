...
namespace Svatk.DAL.Migrations
{
    ...
    [Migration("20240512010242_MigrationAddProfile")]
    partial class MigrationAddProfile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Svatk.Domain.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 5, 12, 1, 2, 42, 27, DateTimeKind.Utc).AddTicks(5827),
                            Login = "svyatmtk",
                            Password = "password"
                        });
                });
